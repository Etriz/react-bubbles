...
- [ ] Explain what a token is used for.
      it is used both for authentication and authorization, to verify the user and their permissions.

- [ ] What steps can you take in your web apps to keep your data secure?
      use private routes and tokens

* [ ] Describe how web servers work.
      they expose paths that apps can use to get, create, modify, and delete data. They then do something with
      the request sent to them and return a response back
